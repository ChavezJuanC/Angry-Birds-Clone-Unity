...
public class Baddie : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip _baddieDeathNote;

    private float _currentHealth;

    private void Awake()
    {
        _currentHealth = _maxHealth; //stats with max health
    }
    ...
    private void Die()
    {
        ...
        AudioSource.PlayClipAtPoint(_baddieDeathNote, transform.position);
        Destroy(gameObject);
    }
